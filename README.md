...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://images.unsplash.com/photo-1593294779311-334a444a17c0'); /* Background image with green trees */
        ...
        .overlay {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(to right, rgba(34, 193, 195, 0.6), rgba(253, 187, 45, 0.6)); /* Gradient overlay */
            z-index: 1; /* Place overlay above the background */
        }

        .tracker-card, .login-card {
            background: rgba(0, 0, 0, 0.8); /* Darker card for contrast */
            border-radius: 20px;
            ...
            z-index: 2; /* Place card above the overlay */
        }
...
<body>
    ...
    <div class="overlay"></div> <!-- Colorful Overlay -->
